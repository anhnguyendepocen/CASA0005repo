...
LondonWards <- st_read(here::here("prac8_data", "NewLondonWard.shp"))
...
My RMarkdown site can be found [here](https://andrewmaclachlan.github.io/PUBLISHEXAMPLE/), but note that i've added a Shiny tab...which is covered in an optional extra.
