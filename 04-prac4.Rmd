...
This week: [Chapter 2 "Basics"](https://bookdown.org/yihui/rmarkdown/basics.html) from R Markdown: The Definitive Guide by Xie, Allaire and Grolemund (2019) and [Chapter 2 "Why RMarkdown"](https://rmd4sci.njtierney.com/why-rmarkdown.html#reproducibility-is-a-problem) from RMarkdown for Scientists by Tierney (2020).  
