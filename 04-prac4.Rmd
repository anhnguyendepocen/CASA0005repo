...
You will probably be met with the VIM (or viewport) window. The best course of action is to input `:q` to quit and accet the default commit message. You will see already that my `test_file.R` has already been placed back in the Git tab and `t<-2+1` again.
