...
```{r prac8_knitt,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
...
```{r prac8_titles,warnings=FALSE, message=FALSE, cache=TRUE, eval=FALSE}
# Title
## Second sub title
### Third sub title
```
...
```{r prac8_publish,echo=FALSE, out.width = "200pt", fig.align='center', cache=TRUE}
...
```{r prac8_sitegenerator,echo=FALSE, out.width = "500pt", fig.align='center', cache=TRUE}
knitr::include_graphics('prac8_images/rsitegenerator.png') 
```

12. In the ```_site.yml``` remove all code and add the following

```{r prac8_yml,eval=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
name: "Hello world"
output_dir: "."
navbar:
...
```{r prac8_newrepo,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
knitr::include_graphics('prac8_images/gitnewrepo.png') 
```

15. Clone the repository by copying the HTTPS 

```{r prac8_HTTPS,echo=FALSE, out.width = "700pt", fig.align='center', cache=TRUE}
...
```{r prac8_addremote,echo=FALSE, out.width = "400pt", fig.align='center', cache=TRUE}
...
```{r prac8_addremote2,echo=FALSE, out.width = "400pt", fig.align='center', cache=TRUE}
...
```{r prac8_render_site,eval=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
rmarkdown::render_site()
```

If you wanted to just build a page from your site --- say if you have made a rather big site with lots of analysis use:

```{r prac8_rendersite2,eval=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r prac8_githubpages,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
...
```{r prac8_markdownsite,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
...
```{r prac8_shiny4, eval=FALSE, cache=TRUE}
####################################### server
...
```{r prac8_runapp,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
...
```{r prac8_publishapp, echo=FALSE, out.width = "400pt", fig.align='center', cache=TRUE}
...
```{r prac8_publishapp2, echo=FALSE, out.width = "400pt", fig.align='center', cache=TRUE}
knitr::include_graphics('prac8_images/publishapp.png') 
```
...
```{r prac8_finalapp,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
...
```{r prac8_inlcudeshiny, fig.align='center', cache=TRUE}
...
```{r prac8_myshiny,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
...
```{r prac8_shungsiteyml,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
...
```{r prac8_ADshiny,cache=TRUE, eval=FALSE}
...
```{r pac8_liemaps,echo=FALSE, out.width = "800pt", fig.align='center', cache=TRUE}
