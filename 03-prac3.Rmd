...
This week: [Chapter 5 "Descriptive statistics"](https://learningstatisticswithr.com/book/descriptives.html) from Learning statistics with R: A tutorial for psychology students and other beginners by Navarro (2019) and [Appendix "Interpolation in R"](https://mgimond.github.io/Spatial/interpolation-in-r.html) from Intro to GIS and Spatial Analysis by Gimond (2019).
