...
1. Landsat data comes zipped twice as a ```.tar.gz```. Use [7Zip](https://www.7-zip.org/) or another file extractor, extract it once to get to a ```.tar``` then extract again and files should appear.
...
manchester_boundary <- st_read(here::here("prac7_data", "manchester_boundary.shp"))
