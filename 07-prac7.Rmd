...
This week: [Appendix "Raster operations in R"](https://mgimond.github.io/Spatial/raster-operations-in-r.html) from Intro to GIS and Spatial Analysis by Gimond (2019) and [Raster manipulation"](https://rspatial.org/raster/spatial/8-rastermanip.html) from Spatial data science by Hijmans (2016). This last one is another tutoiral --- it seems there aren't any decent free raster textbook chapters, let me know if you find one.
