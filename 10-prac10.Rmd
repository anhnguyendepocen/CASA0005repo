...
Before submission, check that your assignment follows the standard model of scientific investigation. You may need to update part 1 based on the analysis you undertook to ensure a seamless narrative throughout. 
:::

::: {.infobox .note data-latex="{note}"}
**Reading**
This week: [Chapter 5 "Control flow"](https://adv-r.hadley.nz/control-flow.html) from Advacned R by Hadley Wickham, [Chapter 10 "Scripts, algorithms and functions"](https://geocompr.robinlovelace.net/algorithms.html) from Geocomputation with R by Lovelace, Nowosad and Muenchow (2020).
...
data <- unzip("prac10_data/statistical-gis-boundaries-london.zip", exdir="prac10_data")
```
