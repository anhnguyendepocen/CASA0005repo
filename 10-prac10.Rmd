...
4. Now read in both of the files using ```lapply()``` that applies a function (here `st_read()` from the `sf` package) to a list 
...
```{r, fig.show="hide", eval=FALSE, include=FALSE, cache=FALSE}
tmap_mode("view")
tm_shape(Borough) +
  tm_borders(lwd=2)+
...
t<-data.frame( R2 = R2(predictions, testData$Wardcount),
