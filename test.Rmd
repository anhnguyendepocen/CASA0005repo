...
if(knitr::is_latex_output()){
    knitr::include_graphics("interactive.png")   
     ...
     file.copy("interactive.html", "~/CASA0005repo/CASA0005repo.github.io/static/img/interactive.html")
    knitr::include_url("https://CASA0005repo.github.io/img/interactive.html")
}
```